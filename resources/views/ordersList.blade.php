...
<div class="jumbotron jumbotron-fluid background-green text-white">
    <div class="container text-center">
        <h1 class="display-4">Live Orders</h1>
        <p class="lead">welcome to Gino's Pizza Store Ordering System</p>
    </div>
</div>
<div class="col-md-12 text-center">
    <a href="{{URL::asset('/getOrders') }}" class="btn btn-success col-md-2">Refresh</a>
</div>
<div class="col-md-12 justify-content-center">
    <div class="row d-flex justify-content-center">
        @foreach ($ordersDeatilsList as $orderDetails)
            <div class="card text-white bg-secondary m-3 col-md-5 background-yellow">
                <div class="card-header">
                    <div class="row justify-content-center m-2">
                        <a href="/inOven/{{$orderDetails['orderId']}}" class="btn btn-success col-md-4">Order Completed</a>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
